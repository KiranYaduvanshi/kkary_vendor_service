      ...
      body: Column(
        ...
        children: [
          ProgressIndecators.linearProgressIndicator(
              ...
              .py(16),
          "Tell us about yourself".text.size(24).semiBold.make().py24().px16(),
          fields(title: "What's your name?", widget: nameField(hint: "Rahul"))
              .px24()
              .py(16),
          fields(title: "What work do you do?", widget: select(lable: "Work"))
              .px24()
              .py16(),
          fields(title: "Where do you live?", widget: select(lable: "Location"))
              .px24()
              .py16(),
          Center(
            child: Container(
              constraints: const BoxConstraints(
                  minWidth: 200, maxWidth: 350, minHeight: 80),
                  ...
                  Column(
                    ...
                    children: [
                      "By preoceeding, you agree to Kkary Company’s"
                          ...
                          .make()
                          .py12(),
                      "Terms & Conditions and Privacy policy".text.bold.make()
                    ],
                  ).px4()
                ],
              ),
